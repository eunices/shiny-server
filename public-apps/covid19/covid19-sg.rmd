...
Up till 1 Apr 2020, data was obtained from `r url1` (which appears to be defunct as of 2 Apr 2020; they migrated to `r url2`.

Subsequently, data was collected based on the MOH press releases. Also retrospectively, prior was augmented from this [Straits Times news article](https://www.straitstimes.com/singapore/health/novel-coronavirus-cases-in-singapore). It provided more information and cluster/links were added, origin  information from previous cases.
...
5. Local linked cases may also be imported or have a travel history. But the former takes precedence. (e.g. case 973 linked to Lee Ah Mooi Home).
6. Long term pass holder/ work pass status seem to be inaccurately captured.
7. confirmed.at.date is press release date, not the confirmed.at.date provided by MOH Annex

Additionally, I tried to adopt the MOH format as it had more information. Certain fields, like links, hospital, locations are missing prior to that. I also changed the citizenship to country names, and camelcase-d everything. I trimmed down columns that were captured in other columns (from `r url1`) as well to prevent conflicting columns (e.g., patient.status).

Henceforth, my data collection from MOH annexes include:

1. Summary of daily stats
2. Getting recovered dates of those who recovered
3. Add new links/ clusters to existing cases
4. Copy and paste new cases from table
5. Add addresses where possible [TBC]
6. Dumping the `r url2` data
...
This is collected in anticipation that case data will subsequently not be released when there are too many cases.

Those who are in critical condition are in ICU. 

These are the deaths, critical condition (ICU), cases in hospital, cases well but still test positive, recovered, new cases (imported), new cases (local), total cases:

Here's a preview of the dataset (first 10 rows):
```{r}
knitr::kable(read.csv("cases.csv")[1:10,], "markdown")
```

Note: Data was only captured from 2 Apr 2020 onwards, refer to "sources.txt" for links.
...
- 2020-04-02: work from home mandated, offense otherwise [source](https://www.channelnewsasia.com/news/singapore/covid-19-work-from-home-singapore-jail-fines-coronavirus-1260222).
- 2020-03-28: defer non-essential trips to malls 
- 2020-03-27: home based learning once a week for primary, secondary schools, and junior college [source](http://go.gov.sg/homebasedlearning)
- 2020-03-26: spacing regulated in malls/ supermarket, e.g. 1 m distance (marked by duct tapes); returnees from UK/ US to stay in hotels [source](https://www.stb.gov.sg/content/stb/en/home-pages/advisory-on-covid-19.html).
- 2020-03-25: large-scale events (>250 people) suspended till 30 Jun
- 2020-03-22: no short-term visitors allowed, work pass only essential services [source](http://go.gov.sg/travel22mar).
- 2020-03-20: ActiveSG sport centres social distancing measures [source](http://go.gov.sg/sport15mar).
- 2020-03-18: Malaysia under lock down till 14 Apr; increased border control measures. [source](http://go.gov.sg/mco)
- 2020-03-17: Singaporeans coming back [source](https://www.straitstimes.com/politics/parliament-coronavirus-cases-to-rise-as-more-overseas-singaporeans-return-home-says-gan-kim)
- 2020-03-16: Singaporeans to defer all non-essential travel [source](http://go.gov.sg/travel-15mar); temporary closure of mosques [source](https://www.muis.gov.sg/Media/Media-Releases/16-Mar-20-Media-Statement-on-Extension-of-Temporary-Closure-of-Mosques).
- 2020-03-14: encourage employers to allow tele-commuting/ staggered work hours [source](http://go.gov.sg/workplacesocialdistancing).
- 2020-03-13: large-scale ticketed events with >250 people to be deferred/cancelled [source](http://go.gov.sg/socialdistancing-13mar)
- 2020-03-11: senior activities suspended, till 24 March - was later extended on 25 Mar [source](http://go.gov.sg/PAseniors).
- 2020-03-10: Port call by Costa Fortuna [source](http://go.gov.sg/mpa9mar).
- 2020-03-07: foreigners to bear cost of covid treatment [source](https://www.channelnewsasia.com/news/singapore/foreigners-to-bear-costs-of-covid-19-treatment-in-singapore-12519500).
- 2020-03-04: work pass holders allowed to return, be tested [source](http://go.gov.sg/mom3mar).
- 2020-02-28: schools with extra precaution [source](http://go.gov.sg/covid19-MOE). 5-6 hours turnaround for test results [
- 2020-02-23: start of travel advisories to outbreak countries other than China (e.g. Daegu, Korea)[source](http://go.gov.sg/mom-27feb).
- 2020-02-17: introduction of Stay Home Notice [source](http://go.gov.sg/StayHomeNotice).
- 2020-02-07: some community spread in Singapore, DORSCON orange. Business continuity plans kick in and temp. screening [source](http://go.gov.sg/dorscon7feb).

Source: https://www.moh.gov.sg/news-highlights/

TODO: categorize policies into tackling different "issues", see if intervention "worked"
...
deceased = df[df$patient.status == "Deceased", c("case", "age", "gender", "patient.nationality",
...
Here we attempt to investigate if there is an association with number of days to recover and age.
