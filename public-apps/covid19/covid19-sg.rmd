...
Data complete up till: 3 Apr 2020
...
6. No more detailed annexes from 5 Apr 2020 onwards, only cluster links and release dates updated.
...
```{r}
knitr::kable(read.csv("cases.csv"), "markdown")
```
