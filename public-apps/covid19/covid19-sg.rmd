...
The data from `r url` differed from MOH:
...
Thus, as of 2 Apr 2020, I tried to adopt the MOH format as it had more information. Thus, certain fields, like links, hospital, locations are blank prior to that. I also changed the citizenship to country names, and camelcase-d everything.
