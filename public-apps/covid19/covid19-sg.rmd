...
renderPlot({
  ...
  plt = ggplot(data=data, aes(x=confirmed.at.date, y=N, fill=infection.source, label=no)) +
  ...
  plt = plt + geom_label_repel(nudge_y=100, angle=90, vjust=0, force=5,
                               fontface='bold', color='black', size=3, 
                               segment.size=0.5, segment.color='black', 
                               box.padding = unit(0.4, 'lines'), fill='grey97',
                               arrow = arrow(length = unit(1, "mm")),
                               point.padding = 0, max.iter=3000)
...
show_measures$event = paste0(show_measures$short, " [", show_measures$no, "] (", 
