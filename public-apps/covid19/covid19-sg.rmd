...
renderPlot({
  ggplot(data=df_cases_day, aes(x=date, y=case_load)) +
    ...
    geom_line(aes(y=I2), color="#35c4cc", size=1) + 
    geom_point(aes(y=I2), color="#35c4cc", size=2) + 
...
- Number of recoveries to date: 
  `r is.recovered[2]`
- Proportion of recoveries to date: 
