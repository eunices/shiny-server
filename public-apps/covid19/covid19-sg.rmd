...
renderPlot({
  ...
  # Plot 2
  data2 = df2[infection.source %in% c("Local transmission", "unknown") & foreign.workers != "y",
  ...
  # Plot 3
  data3 = df2[infection.source %in% c("Local transmission", "unknown") & foreign.workers=="y",
  ...
  plt3 = ggplot(data=data3, aes(x=confirmed.at.date, y=N)) +
    ...
    ggtitle("Migrant worker-related") +
  ...
  # Plots
  grid.arrange(grobs=list(plt1, plt2, plt3))
}, height=900)
```
