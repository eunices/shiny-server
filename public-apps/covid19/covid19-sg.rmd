...
grid.arrange(
  ggplot(data_1st_wave[order(-N)], aes(x=camelcase_labeller("", country.of.origin), y=N)) +
  geom_bar(stat = "identity") + coord_flip() + theme_minimal() +
  xlab("") + ylab("") + ggtitle("First wave"),
  
  ggplot(data_2nd_wave[order(-N)], aes(x=camelcase_labeller("", country.of.origin), y=N)) +
  geom_bar(stat = "identity") + coord_flip() + theme_minimal() +
