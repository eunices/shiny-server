...
renderPlot({
  ...
  plt2a = ggplot(data=data2, aes(x=confirmed.at.date, y=N, fill=patient.citizen, label=no)) +
    geom_bar(position='stack', stat="identity") + 
  ...
  plt2b = ggplot(data=data2, aes(x=confirmed.at.date, y=N, fill=infection.type, label=no)) +
    geom_bar(position='stack', stat="identity") + 
