...
renderPlot({
  ...
  df2 = merge(df, lp_clust[, c("cluster", "type")], by.x="cluster", by.y="cluster",
              all.x=T, all.y=F)
  
  # Plot 2
  data2 = df2[infection.source=="Local transmission" & !(type %in% c("construction", "dormitory")),
  ...
  # Plot 2
  data3 = df2[infection.source=="Local transmission" & (type %in% c("construction", "dormitory")),
